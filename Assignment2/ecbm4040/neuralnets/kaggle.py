...
def my_training_kaggle(X_train, y_train, X_val, y_val, X_test,
             conv_featmap=[6],
             fc_units=[84],
             conv_kernel_size=[5],
             pooling_size=[2],
    ...
    iters = int(_[0].shape[0] / batch_size)
    ...
    with tf.Session() as sess:
        ...
        test_eve, _ = sess.run(eve, feed_dict={xs: X_test,
                                               ys: np.ones(X_test.shape[0]),
                                               is_training: False})
